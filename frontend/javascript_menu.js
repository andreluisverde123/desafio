$(function () {
  ...
  function Create() {
    ...
    alert("CONTATO ARMAZENADO"); //Mensaje de alerta
    return true;
  }
  ...
  function Edit() {
    ...
    //Almacenar los datos en el Local Storage
    localStorage.setItem("tblPersons", JSON.stringify(tblPersons)); 
    alert("CONTATO EDITADO"); //Mensaje de alerta
    return true;
  }
  ...
  function Delete() {
    ...
    localStorage.setItem("tblPersons", JSON.stringify(tblPersons)); 
    alert("CONTATO EXCLUÍDO"); //Mensaje de alerta
  }
  ...
  $(".btnEdit").bind("click", function () {
    ...
    $("#txtGen").val(per.Genero);
    $("#txtAniver").val(per.Aniversario);
...
"<button type='button' class='btn btnEdit' data-toggle='modal' data-target='#exampleModal'> <img src='edit.png' alt='Edit " + i + " 'class='btnEdit'/> </button>" +
                "<button type='button' class='btn btnDelete' data-toggle='modal' data-target='#exampleModal'> <img src='delete.png' alt='Delete" + i + "' class='btnDelete'/> </button>" +